...
def run_experiment_2(csv_path="dataset_fitur_audio.csv"):
    ...
    fitur_skenario_2 = [c for c in df.columns if c.startswith('pitch_') or c.startswith('centroid_') or c.startswith('bandwidth_') or c.startswith('rolloff_')]
    X = df[fitur_skenario_2]
